...
function gameloop() {
	if (gamestate == "menu") {
		...
		contextM.fillRect(0,90,window.innerWidth,40)
		contextM.fillStyle = 'black';
		contextM.fillText("level: " + levelToXp(animationXp),200,200);
		contextM.fillRect(0,100,levelToXp(animationXp)%1*window.innerWidth,20)
